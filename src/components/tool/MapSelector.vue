      ...
      <amap cache-key="coord-picker-map" map-style="amap://styles/macaron" async :center.sync="center" :zoom.sync="zoom" is-hotspot @click="onMapClick">
        ...
        <a-form class="info ant-card ant-card-bordered" layout="inline">
          <!-- <a-form-item label="纵坐标">
            <a-input v-model="position[0]" style="width: 150px" />
          </a-form-item>
          <a-form-item label="横坐标">
            <a-input v-model="position[1]" style="width: 150px" />
          </a-form-item> -->
          <a-form-item label="坐标轴">
            <a-input v-model="positionText" style="width: 200px" />
          </a-form-item>
